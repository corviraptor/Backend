...
data modify entity @e[name="comboSwitchTemp",limit=1] HandItems[0] set from entity @s cardinal_components.apoli:powers.Powers[{Type:"dredgecombat:comboblade/loadout"}].Data.Items[{tag:{LoadoutTool:{Type:combo_sword, Prototype:1b}}}]
...
item modify entity @e[name="comboSwitchTemp",limit=1] weapon.mainhand dredgecombat:comboblade/combo_sword

# add powers from loadout
data modify entity @e[name="comboSwitchTemp",limit=1] HandItems[0].tag.Powers append from entity @s cardinal_components.apoli:powers.Powers[{Type:"dredgecombat:comboblade/loadout"}].Data.Items[{tag:{MoveToken:{ToolTypes:[sword]}}}].tag.Powers[]
