...
item modify block ~ ~1 ~ container.9 dredgecombat:comboblade/skins/hf_blade_axe

item replace block ~ ~1 ~ container.10 with minecraft:netherite_sword 1
item modify block ~ ~1 ~ container.10 dredgecombat:comboblade/skins/hf_blade_sword

# the hf blade modifier here isn't necessary because the combo blade item itself has very little
...
item modify block ~ ~1 ~ container.0 dredgecombat:comboblade/skins/hf_blade_axe
