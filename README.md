Anytime the datapacks or resourcepack is updated, head over to the Actions tab and select the most recent job. You can download the new zip from there. You can also run any of the jobs manually.
